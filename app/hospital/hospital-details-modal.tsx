...
export function HospitalDetailsModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl bg-white dark:bg-[#1e1f28] w-full">
        <div className="flex justify-between w-full">
          ...
          <div className="flex flex-col w-[65%] p-2">
            ...
            <div className="flex  justify-baseline items-center my-4 space-y-1">
              ...
              <Link
                ...
                className="text-[12px] text-blue-400 hover:text-blue-300 ml-4"
              >
