...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen justify-between md:justify-around items-center bg-zinc-50 font-sans dark:bg-black w-full md:px-0 px-1">
      <main className="flex md:flex-row flex-col md:w-[90%] w-full justify-between items-center md:px-0 px-3 h-[75%] md:h-auto">
